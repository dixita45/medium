...
export const Appbar = () => {
  return (
    <div className="border-b flex justify-between px-9 py-4">
      <Link
        to={"/blogs"}
        className="flex text-2xl font-medium text-gray-900 items-center justify-end cursor-pointer"
      >
        Medium
        <svg
          version="1.1"
          ...
          x="0px"
          y="0px"
          width="30px" // Set width to 32px or your desired size
          height="25px" // Set height to 32px or your desired size
