import { Signupinput } from "@dixitabhuva/second-common";
  ...
  return (
    <div>
      ...
      <input
        ...
        type={type || "text"}
        id="first_name"
        className="bg-gray-50 pt-3 border border-black-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
